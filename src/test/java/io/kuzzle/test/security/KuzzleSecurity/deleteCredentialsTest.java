...
public class deleteCredentialsTest {
  ...
  public void testDeleteCredentialsException() throws JSONException {
    ...
    kuzzleSecurity.deleteCredentials("strategy", "kuid", null, listener);
  }

  @Test(expected = RuntimeException.class)
  public void testDeleteCredentialsQueryException() throws JSONException {
  ...
  @Test
  public void testDeleteCredentials() throws JSONException {
    doAnswer(new Answer() {
      @Override
      public Object answer(InvocationOnMock invocation) throws Throwable {
    ...
    kuzzleSecurity.deleteCredentials("strategy", "kuid")
      .deleteCredentials("strategy", "kuid", mock(Options.class))
      .deleteCredentials("strategy", "kuid", mock(ResponseListener.class))
