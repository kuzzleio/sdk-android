...
public class deleteUserTest {
  ...
  public void testDeleteUserNoListener() throws JSONException {
    kuzzleSecurity.deleteUser("foo", new Options());
    ...
    assertEquals(((Kuzzle.QueryArgs) argument.getValue()).getAction(), "deleteUser");
  }
  ...
  public void testDeleteUserValidResponse() throws JSONException {
    ...
    kuzzleSecurity.deleteUser("foobar", new ResponseListener<String>() {
      @Override
  ...
  public void testDeleteUserBadResponse() throws JSONException {
    ...
    kuzzleSecurity.deleteUser("foobar", new Options(), listener);
  }
}
