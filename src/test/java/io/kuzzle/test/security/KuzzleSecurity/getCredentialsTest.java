...
public class getCredentialsTest {
  ...
  public void testGetCredentialsException() throws JSONException {
    ...
    kuzzleSecurity.getCredentials("strategy", "kuid", null, listener);
  }

  @Test(expected = RuntimeException.class)
  public void testGetCredentialsQueryException() throws JSONException {
  ...
  public void testListenerNull() {
    kuzzleSecurity.getCredentials("strategy", null, null);
  }

  @Test
  public void testGetCredentials() throws JSONException {
    doAnswer(new Answer() {
      @Override
      public Object answer(InvocationOnMock invocation) throws Throwable {
    ...
    kuzzleSecurity.getCredentials("strategy", "kuid", mock(ResponseListener.class));
    kuzzleSecurity.getCredentials("strategy", "kuid", mock(Options.class), mock(ResponseListener.class));
    ...
    assertEquals(((Kuzzle.QueryArgs) argument.getValue()).getAction(), "getCredentials");
  }
}
