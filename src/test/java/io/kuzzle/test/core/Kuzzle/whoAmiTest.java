...
public class whoAmiTest {
  ...
  public void testWhoAmIValid() throws JSONException {
    ...
    assertEquals(((io.kuzzle.sdk.core.Kuzzle.QueryArgs) argument.getValue()).getController(), "auth");
    assertEquals(((io.kuzzle.sdk.core.Kuzzle.QueryArgs) argument.getValue()).getAction(), "getCurrentUser");
  }
