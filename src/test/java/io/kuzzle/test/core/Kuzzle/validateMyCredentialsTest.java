...
public class validateMyCredentialsTest {
  ...
  public void testValidateMyCredentialsException() throws JSONException {
    ...
    kuzzle.validateMyCredentials("strategy", credentials, null, listener);
  }

  @Test(expected = RuntimeException.class)
  public void testValidateMyCredentialsQueryException() throws JSONException {
    kuzzle = spy(kuzzle);
  ...
  public void testListenerNull() {
    kuzzle.validateMyCredentials(null, null, null);
  }

  @Test
  public void testValidateMyCredentials() throws JSONException {
    kuzzle = spy(kuzzle);
    doAnswer(new Answer() {
      @Override
      public Object answer(InvocationOnMock invocation) throws Throwable {
    ...
    kuzzle.validateMyCredentials("strategy", credentials, mock(ResponseListener.class));
    kuzzle.validateMyCredentials("strategy", credentials, mock(Options.class), mock(ResponseListener.class));
    ...
    assertEquals(((Kuzzle.QueryArgs) argument.getValue()).getAction(), "validateMyCredentials");
  }
}
